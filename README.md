#JasonWeakley.com
##About
A professional website for myself, Jason Weakley, for employers to view during the hiring process.
##Changes and Notes
2016-06-15: initial commit
##Dependencies
-Frameworks
-Libraries
-Plugins
...
To view this application and its code, copy and paste the following code into your command line.
-```git clone https://```
-```cd directory/sub-directory```
From the sub-directory run:
-```npm install```
-```bower install```
##Serving
